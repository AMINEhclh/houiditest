        ...
        <section className="relative py-12 md:py-32 lg:py-40 px-4 md:px-6 overflow-hidden">
          <div className="max-w-4xl mx-auto text-center relative z-10">
            ...
            >
              ...
              <p className="text-lg md:text-2xl text-muted-foreground max-w-2xl mx-auto mb-8 md:mb-10 text-balance leading-relaxed">We identified clear gaps and opportunities. The next step is fixing them the right way.</p>
